...
typedef enum
{
	CLIENT_INTERACTIVE_CMD_ID      = 0x0200 , //交互数据，可在0x0200~0x02ff选取，具体ID含义由参赛队自定义
...
typedef __packed struct
{
	...
	cmd_ID		 							CmdID;//命令码
	ext_judgesend_custom_header_t   drawFrameHeader;//数据段头结构
	graphic_data_struct_t  	clientDraw;//数据段
